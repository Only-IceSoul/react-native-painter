...
public class SVGViewBox {
    ...
    public static func transform3D(vbRect:CGRect,eRect:CGRect,align:String,meetOrSlice:AspectRatio)->CATransform3D{
    ...
    public static func transformArray(vbRect:CGRect,eRect:CGRect,align:String,meetOrSlice:AspectRatio)->[CGFloat]{
