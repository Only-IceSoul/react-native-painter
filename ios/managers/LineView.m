...
@interface
RCT_EXTERN_MODULE(LineView,RCTViewManager)

RCT_EXPORT_VIEW_PROPERTY(x1, NSNumber)
RCT_EXPORT_VIEW_PROPERTY(y1, NSNumber)
RCT_EXPORT_VIEW_PROPERTY(x2, NSNumber)
RCT_EXPORT_VIEW_PROPERTY(y2, NSNumber)
