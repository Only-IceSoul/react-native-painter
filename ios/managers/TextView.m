...
@interface
RCT_EXTERN_MODULE(TextView,RCTViewManager)

RCT_EXPORT_VIEW_PROPERTY(text, NSString)
RCT_EXPORT_VIEW_PROPERTY(baseline, NSString)
RCT_EXPORT_VIEW_PROPERTY(verticalOffset, NSNumber)
...
RCT_EXPORT_VIEW_PROPERTY(horizontalOffset, NSNumber)
