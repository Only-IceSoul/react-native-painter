...
const PathWeb =  React.forwardRef((props,ref)=>{
...
class Path extends React.PureComponent{
    ...
    handleProps(k,value){
        if(k === 'd'){ 
            ...
            this.updateAttribute(name,value,elfill)
            this.updateAttribute(name,value,elstroke)
    ...
    render(){
        return <PathWeb ref={this.myRef} {...this.props} />
    }
}
